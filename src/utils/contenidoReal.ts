...
export const PUBLICACIONES = [
  // Claudia
  { autorId: 'user-claudia', plataforma: 'facebook' as const, contenido: '¡Qué emoción! Encontré el álbum de fotos del viaje de egreso a Bariloche en 1985. Fuimos 28 compañeros en un micro que no tenía calefacción. ¡Cómo nos reímos esa semana! ¿Alguien tiene la foto de la nevada en el Cerro Catedral?', imagenes: ['/fotos/c1.jpg'], filtro: 'ninguno', hashtags: ['#viaje86', '#bariloche', '#recuerdos'] },
  { autorId: 'user-claudia', plataforma: 'instagram' as const, contenido: 'Antes y después 🥹 1986 → 2026 ❤️', imagenes: ['/fotos/clau.png', '/fotos/CLAU2.png'], filtro: 'sepia', hashtags: ['#antesydespues', '#40años', '#promo86'] },
  // Sandro
  ...
  { autorId: 'user-sandro', plataforma: 'tiktok' as const, contenido: 'Bailando tango como en los 80 🕺💃', videos: ['/fotos/cris_generated.mp4'], hashtags: ['#tango', '#bailando', '#recuerdos'] },
  // Edy
  { autorId: 'user-edy', plataforma: 'instagram' as const, contenido: 'Mi rincón favorito de Córdoba. Las sierras me recuerdan cuando veníamos de excursión con el colegio. ❤️', imagenes: ['/fotos/las 3.jpg'], filtro: 'vintage', hashtags: ['#cordoba', '#sierras', '#naturaleza'] },
  ...
  { autorId: 'user-fabiana', plataforma: 'instagram' as const, contenido: 'Mi pasión: tejer mientras miro el atardecer rosarino 🌅🧶', imagenes: ['/fotos/marca.jpg'], filtro: 'retro80', hashtags: ['#tejido', '#rosario', '#atardecer'] },
  // Jorge
  { autorId: 'user-jorge', plataforma: 'youtube' as const, contenido: 'Documental completo: recorrida por el Instituto Inmaculada Concepción 40 años después. Entrevisté a ex-profesores y recorrí cada aula. Las paredes hablan. 🏫🎥', videos: ['/fotos/cris_generated.mp4'], hashtags: ['#documental', '#colegio', '#40años'] },
  { autorId: 'user-jorge', plataforma: 'facebook' as const, contenido: 'Subí la primera foto del álbum de pesca en Mar del Plata. ¡El mar está espectacular! 🐟🌊 ¿Quién se apunta para una salida?', imagenes: ['/fotos/YO Y MICK.jpg'], hashtags: ['#pesca', '#marplatense', '#jubilado'] },
  // Laura
  { autorId: 'user-laura', plataforma: 'instagram' as const, contenido: 'New York, New York 🗽❤️ Cumpliendo el sueño de conocer Central Park. Me acordé de cuando estudiábamos inglés en el cole y soñábamos con viajar. ¡Nunca es tarde!', imagenes: ['/fotos/las 4.jpg'], filtro: 'ninguno', hashtags: ['#newyork', '#viajes', '#sueños'] },
  ...
  // Mara
  { autorId: 'user-mara', plataforma: 'instagram' as const, contenido: 'La Patagonia es mi lugar en el mundo. Hoy en el lago Nahuel Huapi, 40 años después de haber venido con la promo. Mismo lugar, misma sonrisa. 🏔️💙', imagenes: ['/fotos/tipo.jpg'], filtro: 'ninguno', hashtags: ['#bariloche', '#patagonia', '#feliz'] },
  { autorId: 'user-mara', plataforma: 'tiktok' as const, contenido: 'Desafío: baile como en los 80 🎶💃 ¿Se acuerdan de este tema? 🔥', videos: ['/fotos/cris_generated.mp4'], hashtags: ['#desafiobaila', '#80s', '#dance'] },
  // Mariana
  { autorId: 'user-mariana', plataforma: 'instagram' as const, contenido: 'Desde Cancún con amor 💕🌴 ¡Los extraño mucho! Ojalá puedan venir a visitarme. La casa tiene lugar para todos, armenos una promo vacaciones ☀️', imagenes: ['/fotos/TODOS PLAYA.png'], filtro: 'vintage', hashtags: ['#cancun', '#mexico', '#promo86'] },
  ...
  // Paula
  { autorId: 'user-paula', plataforma: 'facebook' as const, contenido: 'Inaugurando la cosecha de uvas 2026 en Mendoza! 🍇🍷 Si alguien de la promo quiere venir a la vendimia, tengo lugar para 4. ¡El vino corre por mi cuenta!', imagenes: ['/fotos/LAS 7.png'], hashtags: ['#mendoza', '#vino', '#vendimia'] },
  { autorId: 'user-paula', plataforma: 'instagram' as const, contenido: 'Atardecer en los viñedos. La vida es bella. 🌅🍷', imagenes: ['/fotos/la 4.png'], filtro: 'ninguno', hashtags: ['#mendoza', '#vino', '#atardecer'] },
  // Pocha
  ...
  { autorId: 'user-pocha', plataforma: 'instagram' as const, contenido: 'Mi rincón de lectura favorito 📚☕ ¿Recomendaciones de libros?', imagenes: ['/fotos/811.jpg'], filtro: 'ninguno', hashtags: ['#lectura', '#libros', '#recomendar'] },
  // Cristian
  { autorId: 'user-cristian', plataforma: 'tiktok' as const, contenido: 'Tocando "Persiana Americana" en la guitarra criolla. 🎸🎵 ¿Se acuerdan de esta? 🔥', videos: ['/fotos/cris_generated.mp4'], hashtags: ['#guitarra', '#sodastereo', '#musica'] },
  { autorId: 'user-cristian', plataforma: 'youtube' as const, contenido: 'Mi nuevo tema: "Promoción 86" — una canción dedicada a todos ustedes. Espero que les guste. 🎵🎶', videos: ['/fotos/cris_generated.mp4'], hashtags: ['#musicaoriginal', '#promocion86', '#cancion'] },
  // Marcelo
  ...
  { autorId: 'user-marcelo', plataforma: 'instagram' as const, contenido: 'Finde de pesca en el río. Pieza de 5 kilos! 🎣🔥', imagenes: ['/fotos/MIERCOLES 00.jpg'], filtro: 'ninguno', hashtags: ['#pesca', '#rio', '#finde'] },
  // Marito
  { autorId: 'user-marito', plataforma: 'instagram' as const, contenido: 'Ushuaia, el fin del mundo. 🌎❄️ La ciudad más austral del planeta y mi hogar. Los espero a todos para hacer el viaje de la promo acá abajo. ¿Se animan?', imagenes: ['/fotos/todos1.jpg'], filtro: 'ninguno', hashtags: ['#ushuaia', '#findelmundo', '#viaje'] },
  { autorId: 'user-marito', plataforma: 'tiktok' as const, contenido: 'Aurora austral en Ushuaia 🌌✨ Algo que tienen que ver antes de morir.', videos: ['/fotos/cris_generated.mp4'], hashtags: ['#aurora', '#ushuaia', '#naturaleza'] },
]
